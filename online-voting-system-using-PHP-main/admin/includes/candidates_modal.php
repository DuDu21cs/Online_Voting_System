        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Region</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="political_party" class="col-sm-3 control-label">Political Party</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Region</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="edit_political_party" class="col-sm-3 control-label">Political Party</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="edit_political_party" name="political_party" required>
                    </div>
                </div>
                <div class="form-group">
