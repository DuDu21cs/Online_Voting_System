          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table id="votesTable" class="table table-striped table-hover table-bordered">
                  <thead class="thead-dark">
                    <tr>
                      <th>Voter</th>
                      <th>Position</th>
                      <th style="display:none;">Candidate</th>
                      <th>Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                      $sql = "SELECT *, candidates.firstname AS canfirst, candidates.lastname AS canlast, voters.firstname AS votfirst, voters.lastname AS votlast 
                              FROM votes 
                      ...
                      while($row = $query->fetch_assoc()){
                        echo "
                          <tr>
                            ...
                            <td style='display:none;'>".$row['canfirst'].' '.$row['canlast']."</td>
